{!! Form::open(['method' => 'DELETE', 'route' => ['clients.destroy', $client->id], 'enctype' => 'multipart/form-data']) !!}
{{ method_field('delete') }}
    {{ csrf_field() }}
    ...
    <div class="modal fade" id="ModalDelete{{ $client->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Voulez-vous supprimer l'utilisateur <b>{{$client->email}}</b> ? </div>
